...
- [x] 500-step, three-seed long-adaptation experiment ([results](docs/long-adaptation-500-step-results.md))\n- [ ] Phase 6 validation-controlled scaling — early-stopping gate passed; generation evaluation running ([protocol](docs/phase6-validation-scaling.md), [validation results](docs/phase6-validation-gate-results.md), [GPU job](https://huggingface.co/jobs/lakshmianne/6aa3107621047bf1b037372c))
